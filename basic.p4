...
#define payloadsize 160
#define allpktsize 336 /*176(16(do not encoding)+160)+11648(payloadsize1456*8)*/
#define PKTNUMBER 2
...
control MyEgress(inout headers hdr,
    ...
    table NC_init{
        ...
        const entries = {
            (0x0a000101,1234) : encoding_prim(0);
            (0x0a000101,1235) : encoding_prim(1);
        }
    }
    /*
    table processing {
